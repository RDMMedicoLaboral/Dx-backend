...
async function main() {
  ...
  // --- Administrador de la plataforma (sin tenant) ---
  ...
  // --- Centro 1: Laboratorio Clínico San Rafael ---
  ...
  // --- Centro 2: Centro Diagnóstico Manta Salud ---
  ...
  console.log("  Superadmin:   soporte@diagnosticos.app / plataforma123");
  console.log("  Dueño (Lab):  pandrade@sanrafael.demo / demo123");
  console.log("  Dueño (Img):  rcedeno@mantasalud.demo / demo123");
}
